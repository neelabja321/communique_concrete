...
${formData.message}
    ...
    // Construct mailto URL with encoded parameters
              const mailtoUrl = `mailto:info@communiqueconcrete.com?subject=Website Inquiry from ${encodeURIComponent(formData.name)}&body=${encodeURIComponent(emailBody)}`    // Open email client
